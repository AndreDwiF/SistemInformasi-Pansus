    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                    <a href="<?php echo base_url('Auth') ?>">Sistem Informasi Pansus</a>
                    </div>
                    <h1 class="auth-title">Daftar</h1>
                    <p class="auth-subtitle mb-5">Masukkan data Anda untuk mendaftar.</p>

                    <form action="<?php echo base_url('Auth/prosesAuthRegister'); ?>" method="POST">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>Sudah Mempunya Akun? <a href="<?php echo base_url('Auth') ?>"
