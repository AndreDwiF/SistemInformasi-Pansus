<div id="main">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="namaRapat" placeholder="Nama Rapat"class="form-control" required>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Tanggal Rapat </label>                                          
                                                    <input type="date" name="tanggalRapat" placeholder="Nama Tanggal"class="form-control" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Topik</label>
                                                    <select name="topik" id="" class="form-control" required>
                                                    <option value="" >-Pilih-</option>
                                                    <?php foreach($topik as $row) : ?>
                                                    <option value="<?php echo $row->id_topik; ?>"><?php echo $row->nama_topik; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                </div>
        ...
        <div class="modal fade text-left" id="inlineFormEdit<?php echo $row->id_rapat;?>" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel33" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                <form action="<?php echo base_url('Rapat/ProsesEditRapat'); ?>" method="POST">
                                                <div class="form-group">
                                                    <label>Nama Rapat </label>
                                                    <input type="hidden" name="id_rapat" value="<?php echo $row->id_rapat; ?>">                                
                                                    <input type="text" name="namaRapat" placeholder="Nama Rapat"class="form-control" value="<?php echo $row->nama_rapat; ?>" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Tanggal Rapat </label>
                                                    <input type="date" name="tanggalRapat" placeholder="Nama Tanggal"class="form-control" value="<?php echo $row->tanggal_rapat; ?>" required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="topik" id="" class="form-control" required>
                                                    <option value="" >-Pilih-</option>
                                                    <?php foreach($topik as $data) : ?>
                                                    <option value="<?php echo $data->id_topik; ?>" <?php echo $data->id_topik == $row->id_topik ? "selected" : null ?>><?php echo $data->nama_topik; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                </div>
