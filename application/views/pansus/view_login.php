        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Silahkan Masuk Dengan Akun Yang Sudah Terdaftar</p>

                    <form action="<?php echo base_url('Auth/prosesAuthLogin'); ?>" method="POST">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Belum mempunyai akun? <a href="auth-register.html"
